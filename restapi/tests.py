...
class TestModels(TestCase):
    def test_expense(self):
        ...
        self.assertEqual("anc headphone", inserted_expense.description)
        self.assertEqual("music", inserted_expense.category)


class TestViews(TestCase):
    def setUp(self):
        api_key, key = APIKey.objects.create_key(name="expense_service")
    ...
    def test_expense_filter_by_merchant(self):
